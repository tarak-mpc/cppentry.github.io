...
<p><strong>1.4 Spark演进时间表</strong> <br>
演进时间表： <br>
...
Transformations—–    是Spark API的一种类型，Transformation返回值还是一个RDD，所有的Transformation采用的都是懒策略，如果只是将Transformation提交是不会执行计算的 <br>
...
<p><strong>2.3 Spark SQL</strong> <br>
