...
<p> </p>
<p>    <span style="color:#3366ff;"><strong>3）修改当前机器IP </strong></span></p>
...
<p>   </p>
<p>　　<span style="color:#3366ff;"><strong>4）配置hosts文件（<span style="color:#FF0000;">必须<span style="color:#3366ff;">）
...
<p style="text-align:justify;"> </p>
<h3>1.4 所需软件</h3>
<p><span style="color:#3366ff;"><strong>1）JDK软件 </strong></span></p>
...
<p><span style="color:#3366ff;"><strong>2）Hadoop软件 </strong></span></p>
...
<p><span style="color:#3366ff;"><strong>　　1）SSH无密码原理 </strong></span></p>
...
<p><span style="color:#3366ff;"><strong>　　2）Master机器上生成密码对 </strong></span></p>
...
<p><span style="color:#3366ff;"><strong>　　</strong></span></p>
<p><span style="color:#3366ff;"><strong>　　2）在"Master.Hadoop"服务器的操作 </strong></span></p>
<p>　　用到的命令如下：</p>
<p> </p>
<blockquote>
<p>cat ~/id_rsa.pub &gt;&gt; ~/.ssh/authorized_keys</p>
...
<p><span style="color:#3366ff;"><strong>　　1）编辑"/etc/profile"文件 </strong></span></p>
<p> </p>
<blockquote>
<p>vim     /etc/profile</p>
</blockquote>
...
<p> </p>
<p><span style="color:#3366ff;"><strong>　　2）添加Java环境变量 </strong></span></p>
...
<p> </p>
<p><span style="color:#3366ff;"><strong>　　3）使配置生效 </strong></span></p>
...
<p> </p>
<p>    <span style="color:#3366ff;"><strong>1）在"<span style="color:#FF0000;">/usr/hadoop<span style="color:#3366ff;">"创建"<span style="color:#FF0000;">tmp<span style="color:#3366ff;">"文件夹
...
<p> </p>
<p>    <span style="color:#3366ff;"><strong>2）配置"/etc/profile" </strong></span></p>
<p> </p>
<blockquote>
<p>vim /etc/profile</p>
</blockquote>
...
<p>    </p>
<p><span style="color:#3366ff;"><strong>3）重启"/etc/profile" </strong></span></p>
<p> </p>
<blockquote>
<p>source /etc/profile</p>
</blockquote>
...
<p style="text-align:justify;"> </p>
<h3>4.2 配置hadoop</h3>
<p><span style="color:#3366ff;"><strong>　　1）配置hadoop-env.sh </strong></span></p>
...
<p> </p>
<p><span style="color:#3366ff;"><strong>　　2）配置<span style="color:#FF0000;">core-site.xml<span style="color:#3366ff;">文件
</span></span></strong></span></p>
...
<p> </p>
<p><span style="color:#3366ff;"><strong>　　3）配置<span style="color:#FF0000;">hdfs-site.xml<span style="color:#3366ff;">文件
</span></span></strong></span></p>
...
<p> </p>
<p><span style="color:#3366ff;"><strong>　　4）配置<span style="color:#FF0000;">mapred-site.xml<span style="color:#3366ff;">文件
</span></span></strong></span></p>
...
<p> </p>
<p><span style="color:#3366ff;"><strong>　　5）配置masters文件 </strong></span></p>
<p>　　有两种方案：</p>
<p>    （1）第一种</p>
...
<p> </p>
<p>    <span style="color:#3366ff;"><strong>6）配置slaves文件（<span style="color:#FF0000;">Master主机特有</span></strong>）</span></p>
<p>    有两种方案：</p>
<p>    （1）第一种</p>
...
<p>    </p>
<p><span style="color:#3366ff;"><strong>　　2）启动hadoop </strong></span></p>
...
<p> </p>
<p><span style="color:#3366ff;"><strong>　　3）验证hadoop </strong></span></p>
...
<p> </p>
<h3>4.4 网页查看集群</h3>
<p><span style="color:#3366ff;"><strong>　　1）访问"http:192.168.1.2:50030" </strong></span></p>
<p> </p>
<p><img alt="" src="http://images.cnblogs.com/cnblogs_com/xia520pi/201205/201205161427548674.png"></p>
<p> </p>
<p>　　2）访问"<span style="color:#3366ff;"><strong>http:192.168.1.2:50070</strong></span>"</p>
<p> </p>
...
<p><span style="color:#3366ff;"><strong>　　1）先删除"/usr/hadoop/tmp" </strong></span></p>
<p> </p>
<blockquote>
<p>rm -rf /usr/hadoop/tmp</p>
</blockquote>
<p> </p>
<p><span style="color:#3366ff;"><strong>　　2）创建"/usr/hadoop/tmp"文件夹 </strong></span></p>
<p> </p>
<blockquote>
<p>mkdir /usr/hadoop/tmp</p>
</blockquote>
<p> </p>
<p><span style="color:#3366ff;"><strong>　　3）删除"/tmp"下以"hadoop"开头文件 </strong></span></p>
<p> </p>
<blockquote>
<p>rm -rf /tmp/hadoop*</p>
</blockquote>
<p> </p>
<p><span style="color:#3366ff;"><strong>　　4）重新格式化hadoop </strong></span></p>
<p> </p>
<blockquote>
<p>hadoop namenode -format</p>
</blockquote>
<p> </p>
<p><span style="color:#3366ff;"><strong>　　5）启动hadoop </strong></span></p>
<p> </p>
<blockquote>
<p>start-all.sh</p>
</blockquote>
...
<p>　　解决方案是：</p>
<p><span style="color:#3366ff;"><strong>　　1）关闭防火墙 </strong></span></p>
<p> </p>
<blockquote>
<p>service iptables stop</p>
</blockquote>
<p> </p>
<p><span style="color:#3366ff;"><strong>　　2）禁用selinux </strong></span></p>
...
<p>　　解决方案是：修改2个文件。</p>
<p><span style="color:#3366ff;"><strong>　　1）"/etc/security/limits.conf" </strong></span></p>
<p> </p>
<blockquote>
...
<p> </p>
<p><span style="color:#3366ff;"><strong>　　2）"/etc/pam.d/login" </strong></span></p>
<p> </p>
<blockquote>
...
<p>　　解决方案是：</p>
<p><span style="color:#3366ff;"><strong>　　1）检查"/etc/hosts" </strong></span></p>
<p>　　要求本机ip 对应 服务器名</p>
<p>　　要求要包含所有的服务器ip +服务器名</p>
<p><span style="color:#3366ff;"><strong>　　2）检查".ssh/authorized_keys" </strong></span></p>
...
<p><span style="color:#3366ff;"><strong>　　1）从本地服务器复制到远程服务器     </strong></span></p>
...
<p> </p>
<p><span style="color:#3366ff;"><strong>　　2）从远程服务器复制到本地服务器 </strong></span></p>
...
<p> </p>
<blockquote>
<p>　　文章<span style="color:#ff0000;">下载</span>地址：<a href="http://files.cnblogs.com/xia520pi/HadoopCluster_Vol.5.rar" rel="nofollow">http://files.cnblogs.com/xia520pi/HadoopCluster_Vol.5.rar</a></p>
</blockquote>
</div>
<div id="MySignature">
<div class="note">
...
如果，您对我的博客所讲述的内容有兴趣，请继续关注我的后续博客，我是【<a href="http://www.cnblogs.com/xia520pi/" rel="nofollow"><strong class="nb">虾皮★csAxp</strong></a>】。</p>
